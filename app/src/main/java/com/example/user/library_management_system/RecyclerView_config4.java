...
public class RecyclerView_config4 {
    ...
    private RecyclerView_config4.BookAdapter mBooksApapter;
    public void setConfig(RecyclerView recyclerView, Context context, List<book> eeebook, List<String> keys){
        mContext = context;
        mBooksApapter =new  RecyclerView_config4.BookAdapter(eeebook, keys);
    ...
    class BookAdapter extends RecyclerView.Adapter<RecyclerView_config4.BookItemView> {
        ...
        @NonNull
        @Override
        public RecyclerView_config4.BookItemView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            return new RecyclerView_config4.BookItemView(viewGroup);
        }

        @Override
        public void onBindViewHolder(@NonNull RecyclerView_config4.BookItemView bookItemView, int i) {
