...
public class RecyclerView_config6 {
    private Context mContext;
    private BookAdapter mBooksApapter;
    public void setConfig(RecyclerView recyclerView, Context context, List<book> bme, List<String> keys){
        mContext = context;
        mBooksApapter =new  BookAdapter(bme, keys);
    ...
    class BookAdapter extends RecyclerView.Adapter<RecyclerView_config6.BookItemView> {
        List<book> mBookList;
        List<String> mKeys;
