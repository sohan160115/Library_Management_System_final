...
public class RecyclerView_config5 {
    private Context mContext;
    private RecyclerView_config5.BookAdapter mBooksApapter;
    public void setConfig(RecyclerView recyclerView, Context context, List<book> ipebook, List<String> keys){
        mContext = context;
        mBooksApapter =new  RecyclerView_config5.BookAdapter(ipebook, keys);
    ...
    class BookAdapter extends RecyclerView.Adapter<BookItemView> {
        ...
        public BookItemView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            return new RecyclerView_config5.BookItemView(viewGroup);
        }
