...
public class RecyclerView_config3 {
    ...
    private RecyclerView_config3.BookAdapter mBooksApapter;
    public void setConfig(RecyclerView recyclerView, Context context, List<book> cebook, List<String> keys){
        mContext = context;
        mBooksApapter =new  RecyclerView_config3.BookAdapter(cebook, keys);
    ...
    class BookAdapter extends RecyclerView.Adapter<RecyclerView_config2.BookItemView> {
        ...
        @NonNull
        @Override
        public RecyclerView_config2.BookItemView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            return new RecyclerView_config2.BookItemView(viewGroup);
        }

        @Override
        public void onBindViewHolder(@NonNull RecyclerView_config2.BookItemView bookItemView, int i) {
